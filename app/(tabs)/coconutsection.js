  ...
  return (
    <View className="bg-white flex-1 items-center">
       <View className="flex flex-row mt-36 ">
            <TouchableOpacity className="border border-gray-400 w-[150px] h-[150px] rounded-lg ">
            ...
            <TouchableOpacity className="border border-gray-400 w-[150px] h-[150px] rounded-lg ml-5">
            <Image source={require("../../assets/images/Coconut.png")} className="w-[40px] h-[40px] mt-5 ml-14"/>  
